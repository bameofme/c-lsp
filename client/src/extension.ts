...
import { workspace, commands, ExtensionContext, OutputChannel, languages } from 'vscode';
...
export async function activate(context: ExtensionContext) {
	...
	context.subscriptions.push(
		languages.setLanguageConfiguration('cpp', {
		  wordPattern: /(-?\d*\.\d\w*)|([^\`\~\!\@\#\%\^\&\*\(\)\-\=\+\[\{\]\}\\\|\;\:\'\"\,\.\<\>\/\?\s]+)/g,
		}),
		languages.setLanguageConfiguration('c', {
		  wordPattern: /(-?\d*\.\d\w*)|([^\`\~\!\@\#\%\^\&\*\(\)\-\=\+\[\{\]\}\\\|\;\:\'\"\,\.\<\>\/\?\s]+)/g,
		})
	  );
